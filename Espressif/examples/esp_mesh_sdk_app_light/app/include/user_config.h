...
#define ESP_MDNS_SUPPORT 1     /*set 1: enable mdns*/
...
/*============================================================*/
    ...
    #define MESH_INIT_TIME_LIMIT  90000   /*limit time of mesh init*/
    #define MESH_TIME_OUT_MS   90000
    ...
    #define MESH_SSID_PREFIX "ESP_MESH"   /*SET THE DEFAULT MESH SSID PATTEN;THE FINAL SSID OF SOFTAP WOULD BE "MESH_SSID_PREFIX_X_YYYYYY"*/
...
#define DEV_MAC_LEN 6		  /*MAC ADDR LENGTH(BYTES)*/
    ...
    #define ESPNOW_KEY_HASH 1     /*Use hashed value of given key as the espnow encryption key */
    #define ESPNOW_KEY_LEN 16     /*ESPNOW KEY LENGTH,DO NOT CHANGE IT,FIXED AS 16*/
    //#define LIGHT_DEV_NUM  10   /*LIGHT DEV NUMBER FOR CONTROLLER DEV,NOT USED IN LIGHT APP*/
    #define SWITCH_DEV_NUM 5      /*SET THE NUMBER OF THE CONTROLLER DEVICES,IF SET ESPNOW_ENCRYPT,THE NUMBER IS LIMITED TO 5*/
    
    #define LIGHT_MASTER_MAC_LIST_ADDR  0x79 /*flash sec num where keeps the controller mac addresses*/
