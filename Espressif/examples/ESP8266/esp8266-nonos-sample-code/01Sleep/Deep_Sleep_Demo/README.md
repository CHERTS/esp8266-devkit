...
##FOR VERIFY: 
When the board sleeps in deep-mode, the cpu will stop and the board can't connect to AP.The system will restart after the sleeping time is costed.The current will be 0.02mA when the board works in deep-sleep-mode.
